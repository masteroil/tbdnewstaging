			...
			<div class="pin_div" id="my_custom_checkout_field2" style="display:none;">
				...
				<p id="pincode_field_idp" class="form-row my-field-class form-row-wide">
					...
					<span class="input-block">
						...
						<a class="button <?php echo ($textascheck == 1) ? 'phoen_text_inserted' : 'phoen_text_removed'; ?>"
							id="checkpin" onclick="checkPincodeAndReload()">
							<?php echo ($textascheck == 1) ? $checkpintext : ''; ?>
						</a>
				...
				<?php if (is_product()): ?>
					<script>
						...
						function checkPincodeAndReload() {
							var currentPincode = getCookie("pincode_field");
							var inputPincode = document.getElementById('pincode_field_id').value;

							if (currentPincode !== inputPincode) {
								document.cookie = "pincode_field=" + inputPincode + "; path=/";
								location.reload();
							}
						}
					</script>
